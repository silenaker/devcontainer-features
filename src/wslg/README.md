...
Enable WSLg GUI and GPU acceleration support in a dev container.

## Example Usage

```json
"features": {
    "ghcr.io/silenaker/devcontainer-features/wslg:0": {}
}
```
...
|-----|-----|-----|-----|
| useKisakPpa | Use the kisak Mesa PPA for newer Mesa and Vulkan packages. | boolean | false |
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/silenaker/devcontainer-features/blob/main/src/wslg/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
